...
local PublicAddonName = AddonName .. " SNPCs"
local AddonType = "SNPC"
local AutorunFile = "autorun/vj_slvbase_sin_spawn.lua"
-------------------------------------------------------
local VJExists = file.Exists("lua/autorun/vj_base_autorun.lua","GAME")
if VJExists == true then
	include('autorun/vj_controls.lua')

	local vCat = AddonName
	VJ.AddNPC("Quadralex","npc_quadralex",vCat)
	VJ.AddNPC("Hopper","npc_hopper",vCat)
	VJ.AddNPC("Leperkin","npc_leperkin",vCat)
